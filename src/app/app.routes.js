const routes = [
  ...
  },
  {
    path: 'origin',
    loadComponent: () =>
      import('./components/itinerary/origin-screen/origin-screen.component').then(
        (m) => m.OriginScreenComponent
      ),
  },
  {
    path: 'itinerary-basics',
    loadComponent: () =>
      import('./components/itinerary/itinerary-basics/itinerary-basics.component').then(
        (m) => m.ItineraryBasicsComponent
      ),
  },
  {
    path: 'select-destination',
    loadComponent: () =>
      import('./components/itinerary/select-destination/select-destination.component').then(
  ...
  },
  {
    path: 'member-details',
    loadComponent: () =>
      import('./components/itinerary/member-details/member-details.component').then(
  ...
  },
  {
    path: 'members',
    loadComponent: () =>
      import('./components/itinerary/members-list/members-list.component').then(
  ...
  },
  {
    path: 'place-details',
    loadComponent: () =>
      import('./components/itinerary/place-details/place-details.component').then(
